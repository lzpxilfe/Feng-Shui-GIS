...
_MESSAGES = {
    "en": {
        ...
        "panel_subtitle": "Read ridge and hydro structure from DEM first, then compare candidate site layers only when needed.",
        "sites_label": "Site layer",
        ...
        "analysis_desc": "Optional scoring mode for candidate site layers and historical location comparison.",
        ...
        "warn_missing_layers": "Select a site layer and DEM first.",
    ...
    "ko": {
        ...
        "menu_title": "Feng Shui GIS",
        "panel_title": "Feng Shui GIS",
        "panel_subtitle": "DEM으로 능선·수계 골격을 먼저 보고, 필요할 때만 후보지 레이어 비교로 넘어가는 도구입니다.",
        "sites_label": "후보지 레이어",
        "dem_label": "DEM 래스터",
        ...
        "analysis_desc": "후보지 레이어가 있을 때만 정착지·의식/무덤 후보에 대해 점수 기반 비교분석(fs_score)을 실행합니다.",
        ...
        "status_done": "분석 완료.",
        "warn_missing_layers": "후보지 레이어와 DEM을 선택하세요.",
